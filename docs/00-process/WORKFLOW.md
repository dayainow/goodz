...
P0에서는 Project Workbench의 PRD Wizard로 초안을 작성·승인하고 Markdown을 산출물 원본으로 내보냅니다. P1에서는 승인 PRD를 바탕으로 화면·스토리보드·콘셉트를 정리하고 Design Job의 prompt snapshot을 Claude Design에 전달합니다. 결과 제출·수정 요청·승인을 마친 뒤 portable bundle을 개발 handoff로 내보냅니다.
