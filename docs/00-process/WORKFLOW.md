...
P0에서는 Project Workbench의 PRD Wizard로 초안을 작성·승인하고 Markdown을 산출물 원본으로 내보냅니다. P1에서는 승인 PRD를 바탕으로 화면·스토리보드·콘셉트를 정리하고 생성된 handoff prompt를 Claude Design에 전달합니다. Claude Design 결과 URL과 Design Pack을 승인한 뒤 개발 handoff로 이동합니다.
