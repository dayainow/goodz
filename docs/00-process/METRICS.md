...
Goodz v0.8의 목표는 `traceLinks`, CI run, smoke 증거를 운영 판단용 지표로 바꾸고, GitHub timestamp를 이용해 **요청 → 커밋 → CI 성공 → smoke/release** 시간을 계산하는 것입니다.  
...
2. Metrics snapshot을 주간/스프린트 단위로 저장
