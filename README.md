...
> **Lifecycle notice · 2026-07-15 (갱신):** Goodz는 **Usability Closure (S35)** 로 다시 쓸 수 있게 개편 중입니다. 메인 사용 경로는 Process Dashboard의 **프로젝트 → Task → 산출물 → GO**입니다. v1.1.0은 보관 스냅샷이며, Beacon은 선택적 후속 제품입니다 ([DEC-033](./docs/00-process/DECISIONS.md)).
