...
v0.29부터 `@goodz/cli`가 초기화·기존 저장소 adopt·Template migration·프로젝트 생성·산출물 export·Git publish·무결성 검증을 제공합니다. 애플리케이션 scaffold 전체 복사는 아직 Goodz 저장소 Template을 사용합니다.
...
| Goodz CLI | 🟢 init·adopt·template migrate·project create·safe export·Git publish·verify |
